...
\section*{Stili dei caratteri}
Testo con stile normale, \textit{corsivo}, \textbf{grassetto} e
\textbf{\textit{grassetto corsivo}}.

{\sffamily Testo senza grazie con stile normale, \textit{corsivo},
\textbf{grassetto} e \textbf{\textit{grassetto corsivo}}.\par}

\texttt{Monospaziato normale, \textit{corsivo}, \textbf{grassetto} e
\textbf{\textit{grassetto corsivo}}.}
