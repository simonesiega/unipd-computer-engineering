...
In probabilità la barra di condizionamento funziona sia con delimitatori normali,
$\Prob(A\given B)$, sia con delimitatori scalabili:
\[
  \Prob\left(A\givenscaled B\right)=\frac{\Prob(A\cap B)}{\Prob(B)},
